...
public class Transer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.transer);
    ...
    public void onAuthentication(View view){
        ...
        Cursor cs = db.query("ATMAccount",cols,"number = ? AND pass = ?",params,"pass = ?",null,null,null)){
            if(cs.moveToFirst()){
                ...
                Intent intent  = new Intent(getApplication(),Transer_balance.class);
                ...
                mp.start();
                Intent i = new Intent(this, to.msn.wings.atmsimulator.Transer_balance.class);
